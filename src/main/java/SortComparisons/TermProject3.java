...
/*
 ...
 merge sort and quick sort on a reverse almost sorted random array of 1000000 integers. The output
  will be displayed in the console as a table.
 */
public class TermProject3 {
    ...
    public static void main(String[] args) {
        ...
        // Reverse almost sorted random array
        int N = 100000;
        int[] array1 = new int[N]; // Almost sorted Array of 100
        int[] array2 = new int[N];
        int[] array3 = new int[N];

        for (int a = array1.length - 1; a >= 0; a--) {
            if (a % 5 == 0) {
                array1[a] = array2[a] = array3[a] = (int)(Math.random() * N * 2);
            } else {
                array1[a] = array2[a] = array3[a] = N -= 1;
            }
        }
        ...
        // Head of the table
        System.out.println("Table for Reverse Nearly Sorted Array");
        System.out.println("------------------------------------------------------------------------");
