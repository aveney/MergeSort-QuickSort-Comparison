...
/*
 ...
 merge sort and quick sort on an almost sorted random array of 1000000 integers. The output
...
public class TermProject2 {
    ...
    public static void main(String[] args) {
        ...
        // Head of the table
        System.out.println("Table for Nearly Sorted Array");
        System.out.println("------------------------------------------------------------------------");
